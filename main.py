...
if "current_word" not in st.session_state:
    ...
    st.session_state.current_word = list(desd_words[list(desd_words)[st.session_state.counter]])[st.session_state.level_counter]
...
if st.button("Next Word"):
    ...
    if st.session_state.correct >= 3:
        st.session_state.grade_level = list(desd_words)[st.session_state.counter]
...
if st.session_state.wrong >= 3 and st.session_state.total_wrong >= 5:
        st.write(st.session_state.grade_level)
        time.sleep(10)
        exit()
